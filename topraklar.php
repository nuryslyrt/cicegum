...
<tr><td colspan="2">
<?php
    $sorgu = mysql_query("select * from topraklar");
    while($yaz = mysql_fetch_array($sorgu)){
 ?>
 <table border="1" height="60" width="500">
<tr>
    <td rowspan="2" width="50"><img src="<?php echo $yaz['foto'] ?>" width="50" height="50" /></td>
    <td><?php echo $yaz['t_isim'] ?></td>
    <td>Fiyat:<?php echo $yaz['t_ucret'] ?></td>
    <td>Stok Adedi:<?php echo $yaz['stok'] ?></td>
</tr>

<tr>
    <td><?php echo $yaz['hakkinda'] ?></td>
    <td><?php echo $yaz['gubre_katkisi'] ?></td>
    <td colspan="3"><a href="sepeteekle_t.php?id=<?php echo $yaz['t_kayit_no'] ?>">Sepete ekle</a></td>
</tr>
